...
{
    SlidingExpirationInSeconds = builder.Configuration.GetValue<string>("CacheSettings:SlidingExpirationInSeconds"),
    AbsoluteExpirationInSeconds = builder.Configuration.GetValue<string>("CacheSettings:AbsoluteExpirationInSeconds")
};
