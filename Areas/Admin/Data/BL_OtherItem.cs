...
{
    public class BL_OtherItem
    {

            public List<Mod_OtherItem> Get_OtherItemData()
            {

                Mod_OtherItem BL_data;
                List<Mod_OtherItem> current_data = new List<Mod_OtherItem>();
                ...
                try
                {
                    ...
                    SqlParameter sqlP_Asset_Type = new SqlParameter("@Asset_Type", "OtherItem");
            ...
            public int Save_OtherItem_data(Mod_OtherItem Data, string type, string Asset_ID)
            {
                int status = 1;
            ...
            public Mod_OtherItem Get_Data_By_ID(Mod_OtherItem Data , string Asset_Id)
            {
