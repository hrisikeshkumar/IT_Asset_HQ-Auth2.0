...
{
    public class BL_Switch
    {



        public List<Mod_Switch> Get_SwitchData()
        {

            Mod_Switch BL_data;
            List<Mod_Switch> current_data = new List<Mod_Switch>();
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("sp_Computer"))
                {
                    ...
                    SqlParameter sqlP_Asset_Type = new SqlParameter("@Asset_Type", "Switch");
        ...
        public int Save_Switch_data(Mod_Switch Data, string type, string Asset_ID)
        {
            int status = 1;
            ...
            try
            {
                ...
                SqlParameter Asset_Type = new SqlParameter("@Asset_Type", "Switch");
