...
namespace IT_Hardware.Areas.Admin.Data
{
    public class BL_AppleIpad
    {
            public List<Mod_AppleIpad> Get_AppleIpadData()
            {
                ...
                Mod_AppleIpad BL_data;
                List<Mod_AppleIpad> current_data = new List<Mod_AppleIpad>();
            ...
            public int Save_AppleIpad_data(Mod_AppleIpad Data, string type, string Asset_ID)
            {
                int status = 1;
                ...
                try
                {
                    ...
                    SqlParameter Asset_Type = new SqlParameter("@Asset_Type", "AppleIpad");
            ...
            public Mod_AppleIpad Get_Data_By_ID(Mod_AppleIpad Data, string Asset_Id)
            {
