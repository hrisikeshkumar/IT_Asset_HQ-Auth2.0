...
namespace IT_Hardware.Areas.Admin.Data
{
    public class BL_Server
    {
        ...
        public List<Mod_Server> Get_ServerData()
        {

            Mod_Server BL_data;
            List<Mod_Server> current_data = new List<Mod_Server>();
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("sp_Computer"))
                {
                    ...
                    SqlParameter sqlP_Asset_Type = new SqlParameter("@Asset_Type", "Server");
        ...
        public int Save_Server_data(Mod_Server Data, string type, string Asset_ID)
        {
            int status = 1;
            ...
            try
            {
                ...
                SqlParameter Asset_Type = new SqlParameter("@Asset_Type", "Server");
