...
namespace IT_Hardware.Areas.Admin.Data
{
    public class BL_Monitor
    {
        ...
        public List<Mod_Monitor> Get_MonitorData()
        {

            Mod_Monitor BL_data;
            List<Mod_Monitor> current_data = new List<Mod_Monitor>();
        ...
        public int Save_Monitor_data(Mod_Monitor Data, string type, string Asset_ID)
        {
            int status = 1;
