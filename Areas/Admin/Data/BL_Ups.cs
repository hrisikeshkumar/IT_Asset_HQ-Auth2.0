...
namespace IT_Hardware.Areas.Admin.Data
{
    public class BL_Ups
    {
            ...
            public List<Mod_Ups> Get_UpsData()
            {
                ...
                Mod_Ups BL_data;
                List<Mod_Ups> current_data = new List<Mod_Ups>();
            ...
            public int Save_Ups_data(Mod_Ups Data, string type, string Asset_ID)
            {
                int status = 1;
                ...
                try
                {
                    ...
                    SqlParameter Asset_Type = new SqlParameter("@Asset_Type", "Ups");
