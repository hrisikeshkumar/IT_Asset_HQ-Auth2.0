...
{
    public class BL_DC_MisItems
    {


        public List<Mod_DC_MisItems> Get_DC_MisItemsData()
        {

            Mod_DC_MisItems BL_data;
            List<Mod_DC_MisItems> current_data = new List<Mod_DC_MisItems>();
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("sp_Computer"))
                {
                    ...
                    SqlParameter sqlP_Asset_Type = new SqlParameter("@Asset_Type", "DC_MisItem");
        ...
        public int Save_DC_MisItems_data(Mod_DC_MisItems Data, string type, string Asset_ID)
        {
            int status = 1;
            ...
            try
            {
                ...
                SqlParameter Asset_Type = new SqlParameter("@Asset_Type", "DC_MisItem");
