...
{
    public class BL_Scanner
    {


        public List<Mod_Scanner> Get_ScannerData()
        {

            Mod_Scanner BL_data;
            List<Mod_Scanner> current_data = new List<Mod_Scanner>();
        ...
        public int Save_Scanner_data(Mod_Scanner Data, string type, string Asset_ID)
        {
            int status = 1;
            ...
            try
            {
                ...
                SqlParameter Asset_Type = new SqlParameter("@Asset_Type", "Scanner");
