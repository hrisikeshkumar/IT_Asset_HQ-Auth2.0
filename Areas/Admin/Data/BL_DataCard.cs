...
{
    public class BL_DataCard
    {
       
            public List<Mod_DataCard> Get_DataCardData()
            {

                Mod_DataCard BL_data;
                List<Mod_DataCard> current_data = new List<Mod_DataCard>();
                ...
                try
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("sp_Computer"))
                    {
                        ...
                        SqlParameter sqlP_Asset_Type = new SqlParameter("@Asset_Type", "DataCard");
            ...
            public int Save_DataCard_data(Mod_DataCard Data, string type, string Asset_ID)
            {
                int status = 1;
                ...
                SqlParameter Asset_SL_No = new SqlParameter("@Item_serial_No", Data.Item_serial_No);
                    ...
                    SqlParameter Asset_Type = new SqlParameter("@Asset_Type", "DataCard");
            ...
            public Mod_DataCard Get_Data_By_ID(Mod_DataCard Data , string Asset_Id)
            {
